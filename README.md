...
```javascript
import isNotEqualf from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-base-assert-is-not-equal@deno/mod.js';
```
...
```javascript
import isNotEqualf from 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-base-assert-is-not-equal@v0.1.0-deno/mod.js';
```
