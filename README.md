...
```javascript
isNotEqualf = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-base-assert-is-not-equal@umd/browser.js' )
```
...
```javascript
isNotEqualf = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/complex-float32-base-assert-is-not-equal@v0.1.1-umd/browser.js' )
```
